...
AgentMem_dir = os.environ.get("AGENTMEM_DIR") or os.path.join(home_dir, ".AgentMem")
os.makedirs(AgentMem_dir, exist_ok=True)


def setup_config():
    config_path = os.path.join(AgentMem_dir, "config.json")
