...
from AgentMem import Memory, MemoryClient
from AgentMem.configs.prompts import MEMORY_ANSWER_PROMPT
from AgentMem.memory.telemetry import capture_client_event, capture_event
...
class Completions:
    ...
    def _format_query_with_memories(self, messages, relevant_memories):
        ...
        entities = []
        if isinstance(self.mem0_client, AgentMem.memory.main.Memory):
        ...
        elif isinstance(self.mem0_client, AgentMem.client.main.MemoryClient):
