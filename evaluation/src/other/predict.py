...
class ModelPredict:
    ...
    def search_memory(self, idx):
        with open(f"/root/nfs/hmj/proj/mem0/evaluation/src/dataset/all_conversations/{idx}.txt", "r") as file:
            memories = file.read()
...
if __name__ == "__main__":
    ...
    output_file_path = os.path.join(output_folder, f"results_qwen2.5_7b.json")
    parser = argparse.ArgumentParser()
    parser.add_argument("--output_file_path",default=output_file_path,type=str)
    args = parser.parse_args()
    openai_predict = ModelPredict()
    openai_predict.process_data_file("/root/nfs/hmj/proj/mem0/evaluation/src/dataset/locomo1.json", args.output_file_path)
