...
from add import MemoryADD_MINI
...
class MemorySearch_MINI:
    def __init__(self, output_path="results.json", top_k=10, filter_memories=False, is_graph=False):
        self.mem0_client =  Memory.from_config(config)
        self.top_k = top_k
        self.openai_client =  Memory.from_config(config)
...
if __name__ == "__main__":
    memory_manager = MemoryADD_MINI(data_path="/root/nfs/hmj/proj/mem0/evaluation/src/dataset/lcm_test.json", is_graph=False)
    memory_manager.process_all_conversations()

    output_file_path = os.path.join(
                "results/",
                "mem0_results_top_30_filter_False_graph_F.json",
            )
    memory_searcher = MemorySearch_MINI(output_file_path, top_k=30, filter_memories=False, is_graph=False)
    memory_searcher.process_data_file("/root/nfs/hmj/proj/mem0/evaluation/src/dataset/lcm_test.json")